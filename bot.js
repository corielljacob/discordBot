...
client.on('message', msg => {
  ...
  if (msg.content.toLowerCase() === prefix + 'ping') {
    ...
    msg.delete(500)
  } else if (msg.content.toLowerCase().includes('tom') || msg.content.toLowerCase().includes('t o m')||msg.content.toLowerCase().includes('tommy')||msg.content.toLowerCase().includes('t0m')){
    msg.delete(500)
